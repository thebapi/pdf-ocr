        ...
        async.forEachSeries(
          ...
          function (pdf_file, cb) {
            ...
            convert(pdf_file.file_path, quality, function (err, tif_path) {
              ...
              ocr(tif_path, ocr_flags, function (err, outputFilePath) {
                fs.unlink(tif_path, function (tif_cleanup_err, reply) {
                  ...
                  self.emit('page', { hash: hash, outputFilePath : outputFilePath, index: index, num_pages: num_pages, pdf_path: pdf_path, single_page_pdf_path: pdf_file.file_path});
            ...
            self.emit('complete', { hash: hash, outputFiles: outputFiles, pdf_path: pdf_path, single_page_pdf_file_paths: single_page_pdf_file_paths});
          });
      });
    });
  });
